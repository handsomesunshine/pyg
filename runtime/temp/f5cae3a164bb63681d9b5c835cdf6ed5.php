<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"G:\wamp64\www\WWW\pyg\public/../application/home\view\login\register.html";i:1564627427;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="control-group">
                    ...
                    <div class="controls btn-reg">
                        <a id="reg_btn" class="sui-btn btn-block btn-xlarge btn-danger reg-btn"
                           href="javascript:;">完成注册</a><a href="<?php echo url('home/login/mail'); ?>">邮箱注册</a>
                    </div>
                </div>
            </form>
