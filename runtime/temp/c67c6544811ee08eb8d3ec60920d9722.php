<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"G:\wamp64\www\WWW\pyg\public/../application/home\view\goods\detail.html";i:1564629431;s:55:"G:\wamp64\www\WWW\pyg\application\home\view\layout.html";i:1564574279;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="top">
            <div class="py-container">
                <div class="shortcut">
                    ...
                    <ul class="fr">
                        <li class="f-item"><a href="<?php echo url('home/myorder/index'); ?>">我的订单</a></li>
                        <li class="f-item space"></li>
                        <li class="f-item"><a href="javascript:;" target="_blank">我的品优购</a></li>
                        <li class="f-item space"></li>
                        ...
                        <div class="search">
                            <form action="<?php echo url('home/goods/index'); ?>" method="get" class="sui-form form-inline">
                                ...
                                <div class="input-append">
                                    <input type="text" id="autocomplete" type="text" name="keywords" class="input-error input-xxlarge" value="<?php echo \think\Request::instance()->param('keywords'); ?>"/>
                        ...
                        <div class="fr shopcar">
                            <div class="show-shopcar" id="shopcar">
                                ...
                                <a class="sui-btn btn-default btn-xlarge" href="<?php echo url('home/cart/index'); ?>" target="_blank">
                                    <span>我的购物车</span>
                                    <i class="shopnum"><?php echo $number; ?></i>
                                </a>
                                <?php if((empty($number))): ?>
                    ...
                    <div class="all-sorts-list">
                        ...
                        <div class="sort">
                            <div class="all-sort-list2">
                                ...
                                <div class="item">
                                    <h3><a href=""><?php echo $cate['cate_name']; ?></a></h3>
                                    <div class="item-list clearfix">
                                        <div class="subitem">
                                            <?php foreach($cate['son'] as $one): ?>
                                            <dl class="fore1">
                                                <dt><a href=""><?php echo $one['cate_name']; ?></a></dt>
                                                <dd>
                                                    <?php foreach($one['son'] as $two): ?>
                                                    <em><a href="<?php echo url('home/goods/index',['id'=>$two['id']]); ?>"><?php echo $two['cate_name']; ?></a></em>
                                                    <?php endforeach; ?>
                                                </dd>
                                            </dl>
                                            <?php endforeach; ?>
            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom">
                            <img jqimg="<?php echo !empty($goods['goods_images'][0]['pics_big'])?$goods['goods_images'][0]['pics_big']:''; ?>"
                                 src="<?php echo !empty($goods['goods_images'][0]['pics_sma'])?$goods['goods_images'][0]['pics_sma']:''; ?>"/></span>
                    </div>
                    <!--下方的缩略图-->
                    <div class="spec-scroll">
                        ...
                        <div class="items">
                            <ul>
                                <?php foreach($goods['goods_images'] as $image): ?>
                                <li><img src="<?php echo $image['pics_sma']; ?>" bimg="<?php echo $image['pics_big']; ?>" onmousemove="preview(this)"/>
                                </li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                ...
                <div class="clearfix choose">
                    ...
                    <div id="specification" class="summary-wrap clearfix">
                        ...
                        <dl>
                            ...
                            <?php foreach($spec['spec_value'] as $k=>$v): ?>
                            <dd><a spec_value_id="<?php echo $v['id']; ?>" href="javascript:;" class="<?php if(($k==0)): ?>selected<?php endif; ?>"><?php echo $v['spec_value']; ?><span
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="javascript:;" target="_blank" id="addshopcar"
                    ...
                    <div class="tab-content tab-wraped">
                        <div id="one" class="tab-pane active">
                            <ul class="goods-intro unstyled">
                                <?php foreach($goods['goods_attr'] as $attr): ?>
                                <li><?php echo $attr['attr_name']; ?>:<?php echo $attr['attr_value']; ?></li>
                                <?php endforeach; ?>
                            </ul>
