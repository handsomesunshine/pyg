<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"G:\wamp64\www\WWW\pyg\public/../application/home\view\login\login.html";i:1564571967;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="loginform">
                ...
                <div class="tab-content tab-wraped">
                    ...
                    <div id="profile" class="tab-pane  active">
                        <form class="sui-form" id="from" action="<?php echo url('home/login/dologin'); ?>" method="post">
                            ...
                            <div class="logined">
                                <a class="sui-btn btn-block btn-xlarge btn-danger" id="sumbit" target="_blank">登&nbsp;&nbsp;录</a>
                            </div>
                        </form>
                        <div class="otherlogin">
                            <div class="types">
                                <ul>
                                    ...
                                    <li><a href="<?php echo url('home/login/wei'); ?>"><img src="/static/home/img/LOGO_32x32.png" /></a></li>
                                    <li><a href="<?php echo url('home/login/dev'); ?>"><img src="/static/home/img/favicon.ico" /></a></li>
