<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"G:\wamp64\www\WWW\pyg\public/../application/home\view\order\pay.html";i:1564472575;s:55:"G:\wamp64\www\WWW\pyg\application\home\view\layout.html";i:1564574279;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="cart py-container">
    ...
    <div class="checkout py-container  pay">
        <div class="checkout-tit">
            ...
            <div class="paymark">
                <span class="fl">请您在提交订单<em class="orange time">还剩30分00秒</em>之内完成支付，超时订单会自动取消。订单号：<em><?php echo $order_sn; ?></em></span>
        ...
        <div class="checkout-steps">
            ...
            <div class="step-cont">
                <ul class="payType">
                    ...
                    <li pay_code="<?php echo $v['pay_code']; ?>" <?php if(($v['pay_code'] =='alipay')): ?>style="border: 2px solid rgb(228, 57, 60);"<?php endif; ?>><img src="<?php echo $v['logo']; ?>"></li>
                    <?php endforeach; ?>
                </ul>
...
<form id="payForm" method="post" action="<?php echo url('home/order/pay'); ?>">
...
<script type="text/javascript">
    $(function(){
        ...
        var timedata=setInterval(function () {
            ...
            $('.time').html('还剩'+minute+'分'+second+'秒');
        },1000);
