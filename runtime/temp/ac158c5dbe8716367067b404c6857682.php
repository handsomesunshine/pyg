<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"G:\wamp64\www\WWW\pyg\public/../application/home\view\order\create.html";i:1564646140;s:55:"G:\wamp64\www\WWW\pyg\application\home\view\layout.html";i:1564574279;}*/ ?>
<!DOCTYPE html>
<html>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="formdi" method="post" action="<?php echo url('home/order/di'); ?>" class="sui-form form-horizontal">
                                ...
                                <div class="modal-footer">
                                    <button type="button" id="dizhi" data-ok="modal" class="sui-btn btn-primary btn-large">确定</button>
                            ...
                            <div class="sendGoods">
                                ...
                                <ul class="yui3-g">
                                    ...
                                    <li class="yui3-u-7-12">
                                        <div class="desc"><?php echo $v['goods_name']; ?> <?php echo $v['value_names']; ?></div>
...
<form id="orderform" action="<?php echo url('home/order/save'); ?>" method="post">
